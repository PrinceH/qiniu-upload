...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-qiniu-upload', __webpack_require__(4));
    Vue.component('detail-qiniu-upload', __webpack_require__(7));
    Vue.component('form-qiniu-upload', __webpack_require__(10));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_qiniu_js__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_nprogress__ = __webpack_require__(21);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_nprogress_nprogress_css__ = __webpack_require__(22);
        ...
        return {
            file: null, token: '', key: null, observer: {
                next: function next(res) {
                    __WEBPACK_IMPORTED_MODULE_3_nprogress___default.a.set(res.total.percent / 100);
                },
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                axios.get('/qiniu/upload/key').then(function (response) {
                                    _this.token = response.data.token;
                                    _this.file = _this.$refs.QFile.files[0];
                                    console.log(_this.file);
                                    _this.observable = __WEBPACK_IMPORTED_MODULE_2_qiniu_js__["upload"](_this.file, _this.file.name, _this.token);
                                    _this.subscription = _this.observable.subscribe(_this.observer); // 上传开始
                                    _this.subscription.observer.$vue = _this;
                                });
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        ...
        _vm._v(" "),
        _vm.key
          ? _c("span", { staticClass: "text-gray-50 select-none" }, [
